...
--筛选一个网格id有多少个staff_id
select bevy_cust_id,count(1) a from bssdev.f_cms_bevy_cust_staff where bevy_cust_id in (select distinct bevy_cust_id from hjj_temp_20200729) 
group by bevy_cust_id having a >1
